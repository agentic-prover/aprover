# VibeOS Realistic Bug Findings

12 confirmed, **realistic** bugs found by bmc-agent on the
[VibeOS](https://github.com/notgull/vibeos) kernel (~15,000 lines, bare-metal
ARM64). Run: `vibeos_full_check5`, all validation tiers enabled.

This folder is a curated subset of [`../../findings/vibeos/`](../../findings/vibeos/):
the *uncertain* report (BUG-12 `stbtt_GetPackedQuad`) has been excluded so
this view contains only findings judged realistic. File names are kept
identical to the originals to preserve cross-references.
