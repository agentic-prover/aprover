...
Three remediation paths — pick exactly ONE:
...
{{
  "scope": "code-change" | "function-spec" | "project-invariant" | "none",
  "clause": "<C boolean expression — for function-spec or project-invariant>",
